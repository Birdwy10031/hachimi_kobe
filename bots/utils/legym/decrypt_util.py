...
def decrypt_response_body(pyd: str, t: int) -> dict:
    key = get_dynamic_key(t)
    #AES解密后 base64解码 然后转json
    return json.loads(decrypt_aes_ecb_base64(pyd, key))
...
if __name__ == "__main__":
    ...
    decoded_json = decrypt_response_body(pyd, t)
    print(decoded_json)
